...
import usercentric from '../assets/user-centric.jpg';
import analytics from '../assets/analytics.png';
import secure from '../assets/secure.png';
import Basic from "./Basic"; // Import the Basic component for the navigation bar

const AboutPage = () => {
  return (
    <Basic> {/* Wrap the content inside Basic to include the navbar */}
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                component="img"
                height="140"
                image={usercentric} // Replace with your image URL
                alt="Feedback"
              />
              <CardContent>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                component="img"
                height="140"
                image={analytics} // Replace with your image URL
                alt="Analytics"
              />
              <CardContent>
                <Typography variant="h6">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                component="img"
                height="140"
                image={secure} // Replace with your image URL
                alt="Secure"
              />
              <CardContent>
                <Typography variant="h6">
